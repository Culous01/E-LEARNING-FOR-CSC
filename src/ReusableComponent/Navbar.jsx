    ...
    return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative mr-8">
                    ...
                    {/* Mobile menu button*/}
                    <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 cursor-pointer text-blue-950 hover:bg-blue-950/5 focus:outline-2 focus:-outline-offset-1 focus:outline-blue-950">
                ...
                <div className="flex space-x-4">
                    ...
                    <a
                        ...
                        'rounded-md px-3 py-2 text-base hover:bg-blue-950 hover:text-white font-medium',
                        )}
                    >
                        {item.name}
                    </a>
        ...
        <DisclosurePanel className="sm:hidden">
            ...
            {navigation.map((item) => (
                ...
                aria-current={item.current ? 'page' : undefined}
                className={classNames(
                    item.current ? 'bg-gray-950/50 text-white' : 'text-blue-950 hover:bg-blue-950 hover:text-white',
