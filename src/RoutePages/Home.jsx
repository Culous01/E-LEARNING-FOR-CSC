...
const Home = () => {
    return (
        <>
            ...
            <div className='flex justify-center mr-6 lg:-mt-15 md:-mt-13 -mt-5'>
            ...
            <div className='flex flex-col space-y-10 lg:space-y-14 justify-center items-center text-center mt-2'>
                <h1 className='studyHub lg:max-w-4xl md:max-w-3xl max-w-xl/10 px-1 text-3xl/10 md:text-5xl/15 lg:text-7xl/25 font-bold'>YOUR STUDY HUB <br /><span>FOR COMPUTER SCIENCE</span></h1>
